...
a2 = Artist.create!(name: "Harry Liu", genre: "Singer-songwriter from Bay Area, CA. Vibes. Grooves. Jams. Let's go.  These tracks are the culmination of a couple years of work, smiles and laughter from friends from all places.", image_file_name:"https://i.imgur.com/ha2cGju.jpg")
a3 = Artist.create!(name: "Melody Hwang", genre: "Melody Hwang's debut album featuring powerfully expressive songs in a unique blend of modern electronic pop and traditional orchestral tones", image_file_name: "https://i.imgur.com/mMm2gJ8.jpg" )
