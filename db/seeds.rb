...
s28 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Weight" , track_num: 1 , audio_file_name: "" )
s29 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Paper Clouds" , track_num: 2 , audio_file_name: "" )
s30 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Can't You See" , track_num: 3 , audio_file_name: "" )
s31 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Ninth Street" , track_num: 4 , audio_file_name: "" )
s32 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Do I Know Me" , track_num: 5 , audio_file_name: "" )
s33 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Comfort" , track_num: 6 , audio_file_name: "" )
s34 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Bread and Butter" , track_num: 7 , audio_file_name: "" )
s35 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Love Ray" , track_num: 8 , audio_file_name: "" )
s36 = Track.create!(artist_id: a4.id , album_id: al4.id , title: "Hello Friend" , track_num: 9 , audio_file_name: "" )
